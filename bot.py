...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_message(kk.id, "**Hello {}!\nWelcome To {}\n\n__Powerd By : @Divya_y8 __**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
...
async def op(_, m :Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [[
            InlineKeyboardButton("🗯 Channel", url="https://t.me/+DG8B_a0QzYJjOGI1"),
            InlineKeyboardButton("💬 Support", url="https://t.me/+tRjbF_Kd8F85OWFl")
        ]]
    )
    add_user(m.from_user.id)
    await m.reply_photo("https://graph.org/file/d57d6f83abb6b8d0efb02.jpg", caption="**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powered By : @Divya_y8 __**".format(m.from_user.mention, "@Requests_accepts_bot"), reply_markup=keyboard)
...
async def chk(_, cb : CallbackQuery):
    ...
    add_user(m.from_user.id)
    await cb.edit_text(text="**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powered By : @Divya_y8 __**".format(cb.from_user.mention, "@Requests_accepts_bot"), reply_markup=keyboard)
